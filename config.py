...
BOT_USERNAME = getenv("BOT_USERNAME" , "Mitsurixmusicbot")
BOT_NAME = getenv("BOT_NAME" , "MITSURI")
ASSUSERNAME = getenv("ASSUSERNAME" , "mirsuri_assi")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Itachiuchiha786786/MITSURI",)
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = getenv("GIT_TOKEN", None)
PRIVACY_LINK = getenv("PRIVACY_LINK", "https://telegra.ph/Privacy-Policy-for-YukkiMusic-08-30")
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/the_dynamic_network")
